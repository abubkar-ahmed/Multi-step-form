...
function Nav(props) {
  ...
  return (
    <nav className="md:w-[274px] md:h-full md:bg-[url('./src/assets/bg-sidebar-desktop.svg')] bg-[url('./src/assets/bg-sidebar-mobile.svg')] bg-cover md:bg-bottom bg-center bg-no-repeat  md:rounded-2xl md:py-5 py-10 px-5 min-h-[175px]" >
